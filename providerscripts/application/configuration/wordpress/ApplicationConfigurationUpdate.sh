...
# Author: Peter Winter
# Date :  07/07/2016
# Description: When this script runs it will write the wordpress configuration file
...
/usr/bin/run ${HOME}/providerscripts/datastore/configwrapper/PutToConfigDatastore.sh ${HOME}/runtime/wordpress_config.php wordpress_config.php "no"
