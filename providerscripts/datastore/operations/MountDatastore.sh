...
# Author: Peter Winter
# Date :  9/4/2016
# Description: Mount a bucket in your datastore(s) This can be called in 
...
if ( [ "${mode}" = "local" ] )
then
        ${HOME}/providerscripts/datastore/operations/PerformDatastoreMount.sh ${active_bucket} ${count}
