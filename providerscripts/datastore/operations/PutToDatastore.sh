...
# Author: Peter Winter
# Date :  9/4/2016
# Description: Coordinating putting a file into a bucket in the datastore
#####################################################################################
# License Agreement:
...
if ( [ "${mode}" = "local" ] )
then
        ${HOME}/providerscripts/datastore/toolkit/PerformPutToDatastore.sh ${file_to_put} ${active_bucket}/${place_to_put} ${delete} ${count}
