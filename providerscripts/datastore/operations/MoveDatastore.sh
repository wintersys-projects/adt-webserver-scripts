...
# Author: Peter Winter
# Date :  9/4/2016
# Description: Move an object within a datastore. This can be called in 
...
if ( [ "${mode}" = "local" ] )
then
        ${HOME}/providerscripts/datastore/operations/PerformMoveDatastoreObject.sh ${active_bucket}/${original_object} ${active_bucket}/${new_object} ${count}
