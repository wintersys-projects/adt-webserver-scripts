...
# Author: Peter Winter
# Date :  9/4/2016
# Description: Coordinate syncing to a datastore
#####################################################################################
# License Agreement:
...
if ( [ "${mode}" = "local" ] )
then
        ${HOME}/providerscripts/datastore/toolkit/PerformSyncDatastore.sh ${active_bucket}/${original_object} ${active_bucket}/${new_object} ${count}
