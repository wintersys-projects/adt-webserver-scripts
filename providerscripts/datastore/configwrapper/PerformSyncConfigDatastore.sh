...
monitor_for_datastore_changes() {
        ...
        do
                /bin/sleep 10
                /usr/bin/find ${HOME}/runtime/datastore_workarea/config/newdeletes.log -not -newermt '30 seconds ago' -delete
                /usr/bin/find ${HOME}/runtime/datastore_workarea/config/newcreates.log -not -newermt '30 seconds ago' -delete
