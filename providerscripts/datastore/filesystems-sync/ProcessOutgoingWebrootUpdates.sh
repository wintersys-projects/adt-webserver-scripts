...
then
        ${HOME}/providerscripts/datastore/operations/PutToDatastore.sh "sync" "${HOME}/runtime/filesystem_sync/outgoing/additions/additions.${machine_ip}.$$.tar.gz" "filesystem-sync/additions" "distributed" "no"
        ...
        ${HOME}/providerscripts/datastore/operations/PutToDatastore.sh "sync" "${HOME}/runtime/filesystem_sync/outgoing/additions/additions.${machine_ip}.$$.${rnd}.tar.gz" "filesystem-sync/historical/additions" "distributed" "no"
fi

if ( [ -f ${HOME}/runtime/filesystem_sync/outgoing/deletions/deletions.${machine_ip}.$$.log ] )
then
        ${HOME}/providerscripts/datastore/operations/PutToDatastore.sh  "sync" "${HOME}/runtime/filesystem_sync/outgoing/deletions/deletions.${machine_ip}.$$.log" "filesystem-sync/deletions" "distributed" "no"
        ...
        ${HOME}/providerscripts/datastore/operations/PutToDatastore.sh  "sync" "${HOME}/runtime/filesystem_sync/outgoing/deletions/deletions.${machine_ip}.$$.${rnd}.log" "filesystem-sync/historical/deletions" "distributed" "no"
fi
