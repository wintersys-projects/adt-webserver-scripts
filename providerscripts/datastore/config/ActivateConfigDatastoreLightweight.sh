...
monitor_for_datastore_changes() {
        ...
        do
                ...
                then
                        /bin/cp ${HOME}/runtime/datastore_workarea/config/additions_to_perform.log ${HOME}/runtime/datastore_workarea/config/additions_to_perform.log-`/usr/bin/date | /bin/sed 's/ //g'`
