...
do
        ...
        then
                ...
                then
                      ...
                      #  /usr/sbin/geesefs -o allow_other --endpoint="https://${endpoint}" --list-type=1 --uid="${s3fs_uid}" --gid="${s3fs_gid}" --file-mode=0644 --dir-mode=0755 ${asset_bucket} /var/www/html/${asset_directory}    
                        /usr/sbin/geesefs -o allow_other --endpoint="https://${endpoint}" --list-type=1 --file-mode=0644 --dir-mode=0755 ${asset_bucket} /var/www/html/${asset_directory}    
