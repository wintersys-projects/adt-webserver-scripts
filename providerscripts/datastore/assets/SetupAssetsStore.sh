...
do
        ...
        then
                ...
                then
                        ...
                        /usr/sbin/geesefs -o allow_other --endpoint="https://${endpoint}" --uid="${s3fs_uid}" --gid="${s3fs_gid}" --file-mode=0666 --dir-mode=0777 ${asset_bucket} /var/www/html/${asset_directory}    
