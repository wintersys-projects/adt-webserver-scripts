...
do
        ...
        then
                ...
                then
                        ...
                        /usr/bin/geesefs -o allow_other --endpoint="https://${endpoint}" --list-type=1 --uid=${s3fs_uid} --gid=${s3fs_gid} --setuid=${s3fs_uid} --setgid=${s3fs_gid}  --file-mode=0644 --dir-mode=0755  --max-disk-cache-fd 4096 --stat-cache-ttl 60m0s --cache=/home/s3mount_cache --cache-file-mode=0644 ${asset_bucket} ${asset_directory}    
