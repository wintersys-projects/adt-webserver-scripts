...
do
        ...
        then
                ...
                then
                        ...
                        /usr/bin/goofys -o allow_other --endpoint="https://${endpoint}" --uid="${s3fs_uid}" --gid="${s3fs_gid}" --file-mode=0750 ${asset_bucket} /var/www/html/${asset_directory}   
                ...
                then
                      ...
                      #  /usr/sbin/geesefs -o allow_other --endpoint="https://${endpoint}" --uid="${s3fs_uid}" --gid="${s3fs_gid}" --file-mode=0750 ${asset_bucket} /var/www/html/${asset_directory}    
                        /usr/sbin/geesefs -o allow_other --endpoint="https://${endpoint}" --uid="${s3fs_uid}" --gid="${s3fs_gid}" ${asset_bucket} /var/www/html/${asset_directory}    
