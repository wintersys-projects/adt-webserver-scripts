...
# Author : Peter Winter
# Date:    06/07/2016
# Description: This will set the hostname for this machine
#####################################################################################
# License Agreement:
...
/bin/echo "${0} `/bin/date`: Setting the webserver hostname" >> ${HOME}/logs/initialbuild/BUILD_PROCESS_MONITORING.log
/bin/echo "${0} #######################################################################################" >> ${HOME}/logs/initialbuild/BUILD_PROCESS_MONITORING.log
...
/bin/sed -i "s/${WEBSITE_NAME}WS//g" /etc/hostname
