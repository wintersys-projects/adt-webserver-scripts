...
then
        ...
        then
                ...
                then
                        /bin/sed -i 's;/var/www/html;/var/www/html/wordpress;' /etc/nginx/sites-available/${WEBSITE_NAME}
                fi
        fi
fi
...
then
        ...
        then
                if ( [ "`/bin/grep '/var/www/html/public' /etc/nginx/sites-available/${WEBSITE_NAME}`" = "" ] )
                then
                        /bin/sed -i 's;/var/www/html;/var/www/html/web;' /etc/nginx/sites-available/${WEBSITE_NAME}
                fi
        fi
fi
