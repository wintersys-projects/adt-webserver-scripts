...
then
        ...
        apache_modules="mpm_event mod_proxy mod_proxy_http mod_headers mod_ssl mod_proxy_balancer mod_lbmethod_byrequests slotmem_shm"
...
then
        /bin/sed -i "s/#XXXXBASIC-AUTHXXXX//g" ${HOME}/providerscripts/webserver/configuration/reverseproxy/apache/site-available.conf
        /bin/sed -i "s/Require all granted/#Require all granted/g" ${HOME}/providerscripts/webserver/configuration/reverseproxy/apache/site-available.conf
        /bin/sed -i "s;XXXXVPC_IP_RANGEXXXX;127.0.0.1 ${VPC_IP_RANGE};g" ${HOME}/providerscripts/webserver/configuration/reverseproxy/apache/site-available.conf
