...
WEBSITE_URL_ORIGINAL="`${HOME}/providerscripts/utilities/config/ExtractConfigValue.sh 'WEBSITEURLORIGINAL'`"
...
do
    ...
    ${HOME}/providerscripts/email/SendEmail.sh "Authenticated IP claim request for ${WEBSITE_URL_ORIGINAL}" "${message}" MANDATORY ${email_address} "HTML"
