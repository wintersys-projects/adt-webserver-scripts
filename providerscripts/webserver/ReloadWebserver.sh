...
then
  	${HOME}/providerscripts/utilities/processing/RunServiceCommand.sh nginx reload
...
then
  	${HOME}/providerscripts/utilities/processing/RunServiceCommand.sh lighttpd reload
fi
