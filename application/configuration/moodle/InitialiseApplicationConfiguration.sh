...
#if ( [ ! -f /var/lib/adt-config/moodle_config.php ] )
#then#
...
${HOME}/providerscripts/datastore/config/wrapper/GetFromDatastore.sh "config" "moodle_config.php" "/var/www/html/config.php"			
