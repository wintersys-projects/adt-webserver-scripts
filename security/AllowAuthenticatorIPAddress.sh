...
HOST="`${HOME}/providerscripts/datastore/config/wrapper/ListFromConfigDatastore.sh authenticatorip/* | /usr/bin/tr '\n' ' '`"
...
then
        ...
        ip_addresses="`${HOME}/providerscripts/datastore/toolkit/ListFromDatastore.sh "multi-region" "multi-region-auth-laptop-ips/*"`"
