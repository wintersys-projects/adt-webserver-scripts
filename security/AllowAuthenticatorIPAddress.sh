...
HOST="`${HOME}/providerscripts/datastore/operations/ListFromConfigDatastore.sh authenticatorip/* | /usr/bin/tr '\n' ' '`"
...
then
        ...
        ip_addresses="`${HOME}/providerscripts/datastore/operations/ListFromDatastore.sh "multi-region" "multi-region-auth-laptop-ips/*"`"
