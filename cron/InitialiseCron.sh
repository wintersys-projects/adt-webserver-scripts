...
/bin/echo '@hourly export HOME="'${HOME}'" && '${HOME}'/providerscripts/datastore/config/wrapper/DeleteFromConfigDatastore.sh "backuplock.*.file" "yes" "no"' >> /var/spool/cron/crontabs/root
