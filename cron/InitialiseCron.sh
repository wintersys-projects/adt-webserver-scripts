...
then
	...
	then
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 2 && ${HOME}/providerscripts/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '2' '/var/www/html'" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 15 && ${HOME}/providerscripts/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '15' '/var/www/html'" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 30 && ${HOME}/providerscripts/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '30' '/var/www/html'" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 45 && ${HOME}/providerscripts/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '45' '/var/www/html'" >> /var/spool/cron/crontabs/root
	fi
...
/bin/echo '@hourly export HOME="'${HOME}'" && '${HOME}'/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config" "backuplock.*.file" "local"' >> /var/spool/cron/crontabs/root 
...
then
	/bin/echo "@reboot export HOME="${HOME}" && ${HOME}/providerscripts/datastore/filesystems-sync/lightweight/FileSystemSyncController.sh '/var/lib/adt-config'" >> /var/spool/cron/crontabs/root
