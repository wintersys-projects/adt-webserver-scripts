...
/bin/echo '@hourly export HOME="'${HOME}'" && '${HOME}'/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config" "backuplock.*.file"' >> /var/spool/cron/crontabs/root 
