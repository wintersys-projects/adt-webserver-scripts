...
/bin/echo '@hourly export HOME="'${HOME}'" && '${HOME}'/providerscripts/datastore/dedicated/DeleteFromDatastore.sh "config" "backuplock.*.file" "local"' >> /var/spool/cron/crontabs/root 
