...
if ( [ "${apache_modules}" != "" ] )
then
   options=' --host=x86_64-pc-linux-gnu --target=x86_64-pc-linux-gnu --build=x86_64-pc-linux-gnu --prefix /usr/local/apache2 --sysconfdir=/etc/apache2 --enable-mods-shared="${apache_modules}" --enable-nonportable-atomics=yes --with-nghttp2 --with-mpm=prefork --enable-ssl --enable-so --enable-http2'
else
   options=" --host=x86_64-pc-linux-gnu --target=x86_64-pc-linux-gnu --build=x86_64-pc-linux-gnu --prefix /usr/local/apache2 --sysconfdir=/etc/apache2 --enable-mods-shared=all --enable-nonportable-atomics=yes --with-nghttp2 --with-mpm=prefork --enable-ssl --enable-so --enable-http2"  
fi
