...
if ( [ -f ${HOME}/runtime/webroot_audit/modified_webroot_files.dat.previous ] )
then
        /bin/cat ${HOME}/runtime/webroot_audit/modified_webroot_files.dat.previous >> ${HOME}/runtime/webroot_audit/modified_webroot_files.dat
        /bin/rm ${HOME}/runtime/webroot_audit/modified_webroot_files.dat.previous
fi

if ( [ -f ${HOME}/runtime/webroot_audit/added_webroot_files.dat.previous ] )
then
        /bin/cat ${HOME}/runtime/webroot_audit/added_webroot_files.dat.previous >> ${HOME}/runtime/webroot_audit/added_webroot_files.dat
        /bin/rm ${HOME}/runtime/webroot_audit/added_webroot_files.dat.previous
fi
...
do
        ...
        then
                ...
                /bin/grep "Only in" ${HOME}/runtime/webroot_audit/full_webroot_status_report.dat | /bin/grep "^${file}" | /bin/sed 's/: //g' | /bin/grep -o "/var/www/html/.*" >> ${HOME}/runtime/webroot_audit/added_webroot_files.dat.previous
