...
/usr/bin/diff --brief ${diff_exclusion_command} --exclude="${config_file}" /var/www/html /var/www/html1 | /bin/grep -E "(Only in|differ$)" > ${HOME}/runtime/webroot_audit/full_webroot_status_report.dat
