...
then
        ...
        HOST="`${HOME}/providerscripts/datastore/config/wrapper/ListFromConfigDatastore.sh databaseip/*`"
        HOST2="`${HOME}/providerscripts/datastore/config/wrapper/ListFromConfigDatastore.sh databasepublicip/*`"
fi
